...
import MenuComponentFree from "../components/MenuComponentFree"
...
function SonaFree() {
  ...
  useEffect(() => {
    ...
    const alreadyShown =
      localStorage.getItem(DEMO_ALERT_SHOWN_KEY) === "true"

    if (alreadyShown) return

    showAlert({
      title: t("sona.demoMode"),
      description: t("sona.demoText"),
    })

    localStorage.setItem(DEMO_ALERT_SHOWN_KEY, "true")
  }, [])
  ...
  }, [getDemoPreviewUrl, saveAppleLastTrack, updateStoredContextIndex, showAlert, t])
  ...
  }, [isDemoMode, getDemoPreviewUrl, setNeedleByProgress])
  useEffect(() => {
    if (nowPlaying?.track) {
